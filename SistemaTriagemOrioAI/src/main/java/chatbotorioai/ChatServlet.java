...
public class ChatServlet extends HttpServlet {
    ...
    private String fluxoConsulta(String userMessage) {
        ...
        try (Connection conn = Database.connect();
            ...
            if (rs.next()) {
                ...
                String dataFormatada = new SimpleDateFormat("dd/MM/yyyy").format(dataConsulta);

                resetarConversa();
                return "Consulta agendada para o dia " + dataFormatada + " às " + hora + ".\nDeseja realizar outra operação? (sim / sair)";
            } else {
                resetarConversa();
    ...
    private void salvarInformacoes() {
        try (Connection conn = Database.connect()) {
            ...
            int pacienteId = getOrCreatePaciente(conn);
    ...
    private int getOrCreatePaciente(Connection conn) throws SQLException {
        String cpf = sessionData.get("cpf");
        try (PreparedStatement stmt = conn.prepareStatement("SELECT id FROM paciente WHERE cpf = ?")) {
        ...
        try (PreparedStatement stmt = conn.prepareStatement(
            ...
            stmt.setString(1, sessionData.get("nome"));
            stmt.setString(2, cpf);
            stmt.setString(3, sessionData.get("telefone"));
            stmt.setString(4, sessionData.get("email"));
            stmt.setString(5, sessionData.get("nascimento"));
            stmt.executeUpdate();
    ...
    private java.sql.Date converterDataBRParaSQL(String dataBR) throws ParseException {
        SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
